...
namespace SistemaVenta.AplicacionWeb.Utilidades.Automapper
{
    public class AutoMapperProfile : Profile
    {
        ...
        {
            // Configurando la conversion de nuestros modelos

            #region Rol
            // ** creamos el mapeo de el modelo ROl hacia el View model VMROL
            ...
            CreateMap<VMUsuario, Usuario>()
                ...
                .ForMember(destino =>
                    ...
                    opt => opt.Ignore() // ingore la conversion de reversa
                );
            #endregion
            ...
            CreateMap<Negocio, VMNegocio>()
                .ForMember(destino =>
                    ...
                    opt => opt.MapFrom(origen => Convert.ToString(origen.PorcentajeImpuesto.Value, new CultureInfo("es-CO"))) // usamos el convert para convertir a moneda local
                );

            CreateMap<VMNegocio, Negocio>()
                .ForMember(destino =>
                    destino.PorcentajeImpuesto,
                    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.PorcentajeImpuesto, new CultureInfo("es-CO"))) // usamos el convert para convertir a moneda local
                );
            #endregion
