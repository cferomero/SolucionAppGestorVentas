    ...
    public class NegocioService : INegocioService
    {
        ...
        public async Task<Negocio> GuardarCambios(Negocio entidad, Stream Logo = null, string NombreLogo = "")
        {
            try
            {
                ...
                if (Logo != null) // Validamos que el logo no sea nulo
                {
                    string urlLogo = await _firebaseService.SubirStorage(Logo, "carpeta_logo", negocio_encontrado.NombreLogo); // insertamos el logo a firebase
